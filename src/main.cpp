...
uint256 hashGenesisBlock("0xe892ebc98004567ce36f16c68206f803ca2013f0e9e8adb214f327a58ec7f86c");
...
const string strMessageMagic = "ItalyCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // ItalyCoin: 2 days difficoltà
static const int64 nTargetSpacing = 60; // ItalyCoin: crea un blocco ogni 60 secondi 
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal italycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ItalyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe892ebc98004567ce36f16c68206f803ca2013f0e9e8adb214f327a58ec7f86c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "15 Agosto 2013";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1373882400; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 270409;

        if (fTestNet)
        {
            block.nTime    = 1373882400;
            block.nNonce   = 270409;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe72b6d15b6065cada97228d30ef80fd726450692c75d2345c6a60111e67798e8"));
